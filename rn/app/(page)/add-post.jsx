  ...
  const AddPost = () => {
    ...
    const base64Images = useSelector((state) => state.post.base64Images)
    ...
    const pickImage = async () => {
      ...
      if (!result.canceled) {
        ...
        dispatch(addBase64Images(base64Images))
      }
    }
    ...
    const handleCreateEvent = async () => {
      ...
      // console.log(dayjs(startDateText).format("YY-MM-DDThh:mm:ss"))
      // console.log(dayjs(endDateText).format("YY-MM-DDThh:mm:ss"))
      ...
      const createEvent = await EventService.createEvent({
        ...
        showToastWithGravity("Không thể đăng tải bài viết")
        setLoading(false)
      })
      if (createEvent) {
        // Xử lý nếu response trả về
        showToastWithGravity("Tạo bài đăng thành công!")
